...
public interface LeaderService {
    ...
    /**
    * @Description: 领导查询用户可以申请的项目
    * @Param: []
    * @Return: com.management.model.ov.Result
    * @Author: dhp
    * @Date: 2019/9/29
    */
    Result AllAviProject();

    /**
    * @Description: 领导查询负责项目
    * @Param: [leaderId]
    * @Return: com.management.model.ov.Result
    * @Author: dhp
    * @Date: 2019/9/30
    */
    Result ProjectByLeader(String leaderId);

    /**
    * @Description: 查看一个项目的详细信息
    * @Param: [applicationId]
    * @Return: com.management.model.ov.Result
    * @Author: dhp
    * @Date: 2019/9/30
    */
    Result MoreInfo(String applicationId);
}
